...
def get_graphs_from_db(graph_names=None):
    ...
    exclusion_list = [
        ...
        "frb53-24-3", "frb53-24-4", "frb53-24-5",
        "frb59-26-1", "frb59-26-2",
        "frb59-26-3", "frb59-26-5", "frb100-40",
        "frb35-17-1", "frb35-17-2",
    ...
    # connection = sqlite3.connect("fusion.db")
    connection = sqlite3.connect("bhoslib.db")
    # connection = sqlite3.connect("er.db")
    # connection = sqlite3.connect("regular.db")
